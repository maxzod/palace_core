...
/// you can throw `BadRequest(data?)` or `NotFound` or `Unauthorized` and palace_core will
/// ! end the `request` lifecycle
/// ? response to the request based on your exception
/// so if you `throw NotFound()` the palace_core will make the response with code 404
